...
def main():
    ...
    x, y, z = 0.040, 0.015, 0.040 # synthetic y = 0.015
    M = np.array([[x, y, -z, 1.],
                 [x, y, z, 1.],
                 [-x, y, z, 1.],
                 [-x, y, -z, 1.],
    ...
    for i in range(time.shape[0]): # the one you are considering images of
        ...
        if robot_in_cam[0]>0: # x for the distance
            ...
            cv2.imwrite(os.path.join(folder + '../bb/', bb_name.format(i)), img)
